<div class="flex">
    <div x-data="{ open: false }" class="bg-gray-200 h-screen p-5 pt-8  duration-300 relative"
        ...
        <div class="inline-flex">
            <img src="{{asset('img/team.png')}}" class="bg-blue-300 text-4xl rounded cursor-pointer
        ...
        <div class="flex  items-center rounded-md bg-gray-100 mt-6 py-2" :class="!open ? 'px-4' : 'px-2.5'">
            <img src="{{asset('img/search.png')}}" class="tex-white text-lg block float-left cursor-pointer mr-2 ">
